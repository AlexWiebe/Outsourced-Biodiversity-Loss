...
### loadCoarseHoang, loadMammalRanges
{
  ...
  loadBirdRanges = function(){
    # Load range maps
    cc.path = "/scratch/gpfs/clc6/data/bd/ranges_2022_01_04/pub/"
    load(paste0(cc.path, "bird_sf_validated_2022_03_23.RData"))
    
    path_sp_ids = "/scratch/gpfs/rwiebe/forestobligate_bird_ids"
  ...
  loadCoarseHansen = function(){
    ...
    setwd("/scratch/gpfs/rwiebe/") 
    
    path_hansen = "/scratch/gpfs/rwiebe/600m_coarse_hansen_2000"
  ...
  loadCoarseHansenLoss = function(){
    ...
    path_hansenloss = "/scratch/gpfs/rwiebe/600m_coarse_hansenloss"
  ...
  loadCoarseHoang = function(country){
    ...
    path_hoang = paste0("/scratch/gpfs/rwiebe/600m_coarse_hoang/", country)
  ...
  loadMammalRanges = function(){
    ...
    # Load range maps
    mammal_ranges = vect("/scratch/gpfs/rwiebe/Mammal_rangemaps/IUCN_maps.shp")
    
    path_sp_ids = "/scratch/gpfs/rwiebe/forestobligate_mammal_ids"
    dir_sp_ids = list.files(path = path_sp_ids, pattern = "*.csv",
                            full.names = T)
    sp_ids = lapply(dir_sp_ids, tryCSV)
  ...
  loadReptileRanges = function(){
    ...
    path_sp_ids = "/scratch/gpfs/rwiebe/forestobligate_reptile_ids"
    dir_sp_ids = list.files(path = path_sp_ids, pattern = "*.csv",
                            full.names = T)
    sp_ids = lapply(dir_sp_ids, tryCSV)
    sp.ids = do.call(rbind, sp_ids)
    ...
    # Load range maps
    reptile_ranges = vect("/scratch/gpfs/rwiebe/Reptile_rangemaps/REPTILES.shp")
    ...
    # iucn_reptile_ranges = vect("/scratch/gpfs/rwiebe/Reptile_rangemaps/REPTILES.shp")
    # iucn_reptile_ranges = iucn_reptile_ranges[iucn_reptile_ranges$id_no %in% sp.ids,]
    # binomials = iucn_reptile_ranges$binomial
    # reptile_ranges = vect("/scratch/gpfs/rwiebe/Gard_maps/Gard_1_7_ranges.shp")
