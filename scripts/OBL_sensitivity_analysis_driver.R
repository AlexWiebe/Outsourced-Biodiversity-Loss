...
# #   og_raster = sexton
# #   og_raster = terra::classify(og_raster, c(50, 101, 1), right = T, others = 0)
# #   # right = T to not include 101 in the range (not that there are any pixels with value 101),
# #   # and others = 0 sets anything outside 50-100 to 0
# #   print(Sys.time())
...
# #   new_raster = project(new_raster, crs(hansen_ref))
...
# # hansen_ref = rast("/scratch/gpfs/rwiebe/Hansen_30m_2000_final/hansen1.tif") # reference for CRS
# # 
# # start_index = 1
...
# #                 filename = paste0("/scratch/gpfs/rwiebe/sexton600m/",i,".tif"),
# #                 overwrite = T)
# #     gc()
# #   }, error = function(e){
